...
animal_legs <- data.frame(animal = c("cow", "fish", "chicken", "dog", "sheep"),
                          n_legs = c(4, 0, 2, 4, 4))

animal_sounds <- data.frame(animal = c("cow", "chicken", "cat", "sheep", "dog"),
                            sounds = c("mooo", "cluck", "meow", "baaa", "bark"))

animal_pats_farm <- data.frame(animals = c("cow", "fish", "chicken", "dog", "cat", "sheep"),
...
merge(animal_legs, animal_pats_farm, all = FALSE,
      by.x = "animal", by.y = "animals") #inner join
