test_that("Read in fasta formatted data generates data frame",{
  ...
  expected <- data.frame(id = c("seqA", "seqB", "seqC", "seqD", "seq4", "seq_4", "seqE"),
                         sequence = c("ATGCATGC", "TACGTACG", "TCCGATGC", "TCCGATGC", "TCCGATGC", "TCCGATGC", "TCCGATGCTCCGATGC"),
                         comment = c("", "", "", "B.ceresus UW85", "E. coli K12\tBacteria;Proteobacteria;", "Salmonella LT2\tBacteria;Proteobacteria;", "B.ceresus UW123"))
